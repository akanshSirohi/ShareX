...
abstract public class SwipeDeleteCallback extends ItemTouchHelper.Callback {
    ...
    public SwipeDeleteCallback(Context context) {
        ...
        backgroundColor = Color.parseColor("#FFFF1414");
        mClearPaint = new Paint();
        mClearPaint.setXfermode(new PorterDuffXfermode(PorterDuff.Mode.CLEAR));
        deleteDrawable = ContextCompat.getDrawable(mContext, R.drawable.ic_delete_swipe);
    ...
    public void onChildDraw(@NonNull Canvas c, @NonNull RecyclerView recyclerView, @NonNull RecyclerView.ViewHolder viewHolder, float dX, float dY, int actionState, boolean isCurrentlyActive) {
        ...
        int deleteIconLeft =  deleteIconMargin - intrinsicWidth;
        int deleteIconRight =  deleteIconMargin;
